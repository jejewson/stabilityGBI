...
This notebook contains the code to reproduce the experiments of Section 6.3  of ''On the Stability of General Bayesian Inference'' Jewson, Smith and Holmes (2023) 
...
betaBayes_logisticRegression_data <- list(n = n_cc, p = p_cc, y = matrix(colon_cancer_Y, nrow = n_cc, ncol = 1), X = colon_cancer_X_std, mu_beta = mu_0, beta_s = v_0, w = 1, beta_p = 0.5)
...
betaBayes_t_logisticRegression_wbeta_data <- list(n = n_cc, p = p_cc, y = matrix(colon_cancer_Y, nrow = n_cc, ncol = 1), X = colon_cancer_X_std, mu_beta = mu_0, beta_s = v_0, w = 1, t = 1.25,  beta_p = 0.5, w_beta = w_t_beta_hat$minimum)
...
betaBayes_probitRegression_wbeta_data <- list(n = n_cc, p = p_cc, y = matrix(colon_cancer_Y, nrow = n_cc, ncol = 1), X = colon_cancer_X_std, mu_beta = mu_0, beta_s = v_0, w = 1, beta_p = 0.5, w_beta = w_probit_beta_hat$minimum)
...
betaBayes_logisticRegression_mislabelled_data <- list(n = n_cc, p = p_cc, y = matrix(colon_cancer_Y, nrow = n_cc, ncol = 1), X = colon_cancer_X_std, mu_beta = mu_0, beta_s = v_0, eta_bound = c(0, 0.05), w = 1, beta_p = 0.5)
